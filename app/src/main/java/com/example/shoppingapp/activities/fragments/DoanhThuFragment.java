...
public class DoanhThuFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference("doanhso").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                list=new ArrayList<>();
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    String str = dataSnapshot.child("thang").getValue(String.class)+"\t"+dataSnapshot.child("ds").getValue(Integer.class)+".000 đ";
